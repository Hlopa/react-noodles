      ...
      <div className="container">
        <div className="header__inner">
          <Link to='/' className='logo'>
            <svg
              x="0px" y="0px" viewBox="0 0 463 463" fill="#ffffff">
              <g>
                <g>
                  <g>
                    ...
                    <path
                      d="M196.325,154.948c1.004,0,2.025-0.203,3.004-0.632c3.794-1.662,5.523-6.084,3.862-9.878
            ...
            <div className="logo__text">
              Хочу лапшу
						<span>Быстрая доставка вкусной еды</span>
            </div>
          </Link>
          <Link to='/cart' className='header__cart'>
            <span className="icon-shopping-cart"></span>
            {totalPrice > 0
              ? <div className="header__cart-total">{totalPrice} руб</div>
              : <div className="header__cart-total"></div>}
          </Link>
        </div>
      </div>
    </header>
